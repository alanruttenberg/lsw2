 ...
 */
public class LSWTreeView extends Display {
    ...
    public LSWTreeView(Tree t, String label,int initial_depth) {
    ...
    public static JComponent demo(String datafile, final String label,String initial_depth, String maximum_depth) {
        ...
        final LSWTreeView tview = new LSWTreeView(t, label,Integer.parseInt(initial_depth));
    ...
    public static class SliderChangeListener implements ChangeListener {
    	...
    	private LSWTreeView view;
    	
    	public SliderChangeListener(LSWTreeView v) { 
    		view = v;
    	}
