...
(defun not-wff-error (x &optional *subst-for-printing*)
  (error "~A is not a formula." x))

(defun not-clause-error (x &optional *subst-for-printing*)
  (error "~A is not a clause." x))
